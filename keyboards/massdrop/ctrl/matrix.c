...
uint32_t row_masks[2]; //Array size must match number of unique MCU ports used for reads (PA, PB, PC, etc)
...
uint8_t matrix_scan(void)
{
    ...
    uint8_t row;
    uint8_t col;
    uint32_t scans[2]; //Array size must match number of unique MCU ports used for reads (PA, PB, PC, etc)
